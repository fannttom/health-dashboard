...
export default function Home() {
  ...
  // Расчёт прогнозов восстановления
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
        <Card className="bg-blue-50">
          <CardContent className="p-6 text-center">
            ...
            {readinessScore >= 80 ? (
              <div className="text-green-600 text-lg font-semibold">Отличная форма! Можно тренироваться активно.</div>
            ) : readinessScore >= 60 ? (
              <div className="text-yellow-600 text-lg font-semibold">Форма средняя. Рекомендую контролировать нагрузку.</div>
            ) : (
              <div className="text-red-600 text-lg font-semibold">Форма снижена. Лучше запланировать восстановление.</div>
            )}
          </CardContent>
        </Card>
      </motion.div>
            ...
            <CardContent className="p-6">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={recoveryPredictions}>
                  ...
                  <YAxis domain={[0, 100]} />
                  <Tooltip />
                  <Line type="monotone" dataKey="recoveryScore" stroke="#4CAF50" />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
          ...
          <CardContent className="p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={sleepChartData}>
                ...
                <Tooltip />
                <Line type="monotone" dataKey="sleepDurationHours" stroke="#8884d8" />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart>
                ...
                <YAxis />
                <Tooltip />
                <Line dataKey="fitness" data={fitness} name="Фитнес (CTL)" stroke="#4CAF50" />
                <Line dataKey="fatigue" data={fatigue} name="Усталость (ATL)" stroke="#F44336" />
                <Line dataKey="form" data={form} name="Форма (TSB)" stroke="#2196F3" />
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
